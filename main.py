...
# Removed unused test endpoints: / and /items/{item_id}
...
# Removed unused test endpoint: /test-token
...
# Removed legacy endpoints - now available in /api/v1/agent/*:
# - /agent/approvals -> /api/v1/agent/approvals (removed)
# - /agent/approved-trades -> /api/v1/agent/approved-trades (removed)
# - /agent/logs -> removed (not used in frontend)
# - /agent/tool-executions -> removed (not used in frontend)
# - /agent/simulations -> removed (not used in frontend)
# - /agent/chat-history -> removed (not used in frontend)

# Removed legacy endpoints - now available in /api/v1/agent/*:
# - /agent/approve/{approval_id} -> /api/v1/agent/approve/{approval_id}
# - /agent/reject/{approval_id} -> /api/v1/agent/reject/{approval_id}
# - /agent/config (GET/POST) -> /api/v1/agent/config
