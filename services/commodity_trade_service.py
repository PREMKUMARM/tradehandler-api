"""
Commodity wizard — indicator-based LIMIT entry + SL-M stepped exit.
"""
...
def place_gtt_for_plan(
    ...
    *,
    ...
    out["gtt_trigger_id"] = out.get("sl_order_id")
    return out
...
def place_trade(
    ...
    if not can_execute:
        ...
        result["errors"].extend(can_execute_block_errors(preview, plan, segment="commodity"))
        return result
